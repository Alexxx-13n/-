...
author: "Никитин Александр Владимирович, НФИбд-03-19"
...
csl: pandoc/csl/gost-r-7-0-5-3708-numeric.csl
...
header-includes:
  ...
  - \floatingpenalty = 37000 # penalty for splitting an insertion (can only be split footnote in standard LaTeX)
...
<p>Студент: Никитин Александр Владимирович 
...
![photo3. Уравнения для модели варианта-37](photo/8.png "Уравнения для модели варианта-37")
...
https://esystem.rudn.ru/pluginfile.php/1343893/mod_resource/content/2/Лабораторная%37работа%37№%376.pdf
